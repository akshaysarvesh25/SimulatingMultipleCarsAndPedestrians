...
add_block('LargeScaleSimLib_old/Synchronize_with_ROS2','MultipleCarsPedestrians/sync_with_ros_1');
...
add_block('LargeScaleSimLib_old/Synchronize_with_ROS2','Partition2/sync_with_ros_2');
figure
h = plot(G)
